...
#include "custom/lesoir/config/acl_extcache.vcl";
#include "custom/lesoir/config/acl_freshforce.vcl";
include "custom/lesoir/config/acl_purge.vcl";
...
#include "custom/lesoir/errorpages/errorpage_200_inline.vcl";
include "custom/lesoir/errorpages/errorpage_403_inline.vcl";
#include "custom/lesoir/errorpages/errorpage_503_inline.vcl";
include "custom/lesoir/errorpages/errorpage_404.vcl";
## default errorpage must come last in vcl_error()
include "custom/lesoir/errorpages/errorpage_default_inline.vcl";
