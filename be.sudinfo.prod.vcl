...
#include "custom/sudinfo/config/acl_extcache.vcl";
#include "custom/sudinfo/config/acl_freshforce.vcl";
#include "custom/sudinfo/config/acl_purge.vcl";
...
## accept only GET, HEAD, POST method.
...
#include "custom/sudinfo/errorpages/errorpage_200_inline.vcl";
include "custom/sudinfo/errorpages/errorpage_403_inline.vcl";
#include "custom/sudinfo/errorpages/errorpage_503_inline.vcl";
include "custom/sudinfo/errorpages/errorpage_404.vcl";
## default errorpage must come last in vcl_error()
include "custom/sudinfo/errorpages/errorpage_default_inline.vcl";
